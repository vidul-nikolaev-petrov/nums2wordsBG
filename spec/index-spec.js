...
describe("currency tests", () => {
    ...
    it("следва да върне 'сто и един хиляди лева и деветдесет и девет стотинки'", () => {
        expect(translate.currency("101000.99")).toBe("сто и един хиляди лева и деветдесет и девет стотинки");
    });
});